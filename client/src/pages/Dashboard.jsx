      ...
      <main className="max-w-6xl mx-auto px-8 py-8 space-y-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-5">
            ...
            <button className="text-sm text-gray-500 border border-gray-200 rounded-xl px-4 py-1.5 hover:bg-gray-50 transition-colors">
              View All
            </button>
          </div>
          <div className="space-y-3">
            {alerts.map((alert) => (
              <div
                key={alert.name}
                className="flex items-center justify-between border border-gray-100 rounded-xl px-5 py-4 hover:bg-gray-50 transition-colors"
              >
                <div>
                  <p className="font-semibold text-gray-800">{alert.name}</p>
                  <p className="text-sm text-gray-400">{alert.date}</p>
                </div>
                <span className={`text-white text-xs font-semibold px-4 py-1.5 rounded-full ${alert.tagColor}`}>
                  {alert.tag}
                </span>
              </div>
            ))}
