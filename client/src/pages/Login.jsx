            ...
            <div className="w-full max-w-110 rounded-3xl bg-white rounded-5xl border border-slate-100 p-5 shadow-[0_10px_30px_rgba(0,0,0,0.06),0_2px_10px_rgba(0,0,0,0.04)]">
                ...
                <form onSubmit={handleSignIn} className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input type="email" placeholder="your.email@school.edu" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full px-4 py-2.75 rounded-xl border border-[#e5e7eb] text-[14.5px] text-[#1a1d2e] placeholder-[#b0b7c3] outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition" />
                    </div>

                    {/* Password */}
                    <div className="flex flex-col gap-1.5">
                        <label className="text-[14px] font-medium text-[#374151]">Password</label>
                        <input type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full px-4 py-2.75 rounded-xl border border-[#e5e7eb] text-[14.5px] text-[#1a1d2e] placeholder-[#b0b7c3] outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition" />
                    </div>
